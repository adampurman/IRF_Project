...
namespace uib3pn_IRF_project
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (actionbutton.ismodified)
            {
                int index = EmployeesToExport.FindIndex(x => x.FirstName == actionbutton.modifiedEmployee.FirstName);

                EmployeesToExport[index] = actionbutton.modifiedEmployee;
            }
